# Evaluación 1 - Desarrollo Front-End con React

**Asignatura:** Desarrollo de Aplicaciones Web  
**Carrera:** Ingeniería Civil Informática  
**Institución:** Universidad Autónoma de Temuco  
**Integrantes:** Jomni Ruiz, Harold Morón  
...
- `App.jsx`: Componente principal que orquesta la vista.
- `Navbar.jsx`: Barra de navegación superior responsiva con menú móvil.
- `HeroSection.jsx`: Sección central con llamado a la acción e información principal.
